...
Module mdlSimpanPinjam_Delete
    ...
    Public Sub delete_pinjam(ByVal var_no_pinjam As String, ByVal var_no_jual As String, ByVal var_id_item As String, ByVal var_item_name As String, ByVal var_nominal As Double, ByVal var_date_trn As Date, ByVal var_flag_surat As Integer, ByVal berat As Double, ByVal trnid As String, ByVal var_created_user As String, ByVal var_created_date As Date, ByVal var_modified_user As String, ByVal var_modified_date As Date)
        ...
        With cmd_sqldelete
            .Connection = conn
            .CommandText = "call sp_pinjaman ('" & var_no_pinjam & "','" & var_no_jual & "','" & var_id_item & "','" & var_item_name & "'," & var_nominal & ",'" & Format(var_date_trn, "yyyy-MM-dd") & "'," & var_flag_surat & "," & berat & ",'DELETE','" & Format(var_created_date, "yyyy-MM-dd hh:mm:ss") & "','" & var_created_user & "','" & Format(var_modified_date, "yyyy-MM-dd hh:mm:ss") & "','" & var_modified_user & "')"
