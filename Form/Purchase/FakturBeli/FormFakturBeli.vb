...
Public Class FormFakturBeli
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            pathfilereport = Application.StartupPath & "\Report\FakturBeli.rpt"
            Dim da As New MySqlDataAdapter()
            Dim ds As New DataSet()
            Dim qryCompanies As String = "SELECT * FROM view_ctk_purchase where no_purchase = '" & frmpurchase.NoBuktiFaktur & "'"
            ...
            R.Refresh()
            R.RecordSelectionFormula = "{view_ctk_so1.no_purchase} ='" & frmpurchase.NoBuktiFaktur & "'"
            With CRviewer
                .ReportSource = R
