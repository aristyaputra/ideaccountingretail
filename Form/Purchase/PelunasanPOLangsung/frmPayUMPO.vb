...
Public Class frmPayUMPO
    ...
    Private Sub frmreceiptmoney_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Call insert_no_trans("PELUNASAN_PO", Month(txt_date.Value), Year(txt_date.Value))
        Call select_control_no("PELUNASAN_PO", "TRANS")
    ...
    Private Sub btn_save2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_save2.Click
        open_conn()
        If insert = 1 Then
            If getTemplateAkses(username, "MN_PURCHASE_UM_LUNAS_ADD") <> True Then
        ...
        If edit = 1 Then
            If getTemplateAkses(username, "MN_PURCHASE_UM_LUNAS_EDIT") <> True Then
                Dim info As AlertInfo = New AlertInfo("Cek Kevaliditasan Data", "Anda tidak memiliki hak akses")
                alertControl_warning.Show(Me, info)
                Exit Sub
            End If
    ...
    Private Sub insert_data()
        ...
        Try
            ...
            If insert = 1 Then
                'Call delete_i_cogs()
                Call insert_pelunasan_po(Trim(txt_inv_no.Text), Format(txt_date.Value, "yyyy-MM-dd"), Lookup_Pelanggan.EditValue, _
                                ...
                                0, "", "", 0, "", 0, 0, Trim(txt_curr.Text), 0, 0, "INSERT", 0, var_po, Replace(txt_disc.Text, "%", ""), cbo_akun.Text, "", Replace(txt_kurs.Text, ",", ""), Replace(txt_um.Text, ",", ""), cbo_gudang.EditValue)
                For i = 0 To DataGridView1.Rows.Count - 1
                    Call insert_pelunasan_po(Trim(txt_inv_no.Text), Format(txt_date.Value, "yyyy-MM-dd"), "", "", 0, 0, 0, 0, 0, _
                                                        ...
                                                        txt_curr.Text, 1, i, "INSERT", 0, var_po, Replace(txt_disc.Text, "%", ""), cbo_akun.Text, DataGridView1.Item(2, i).Value, Replace(txt_kurs.Text, ",", ""), Replace(txt_um.Text, ",", ""), cbo_gudang.EditValue)
                ...
                If param_sukses = True Then
                    ...
                    update_no_trans(txt_date.Value, "PELUNASAN_PO")
            ...
            ElseIf edit = 1 Then
                ...
                Call update_pelunasan_po(Trim(txt_inv_no.Text), Format(txt_date.Value, "yyyy-MM-dd"), Lookup_Pelanggan.EditValue, _
                                var_id_supplier, var_pay_method, txt_payterm.Text, txt_discterm.Text, Replace(txt_disc_pay.Text, "%", ""), _
                                txt_subtotal.Text, txt_freight.Text, Replace(txt_tax.Text, "%", ""), txt_amount.Text, Trim(txt_comment.Text), _
                                username, Format(server_datetime(), "yyyy-MM-dd"), username, Format(server_datetime(), "yyyy-MM-dd"), _
                                0, "", "", 0, "", 0, 0, Trim(txt_curr.Text), 0, 0, "UPDATE", 0, var_po, Replace(txt_disc.Text, "%", ""), cbo_akun.Text, "", Replace(txt_kurs.Text, ",", ""), Replace(txt_um.Text, ",", ""), cbo_gudang.EditValue)
                For i = 0 To DataGridView1.Rows.Count - 1
                    Call update_pelunasan_po(Trim(txt_inv_no.Text), Format(txt_date.Value, "yyyy-MM-dd"), "", "", 0, 0, 0, 0, 0, _
                                                        0, 0, 0, "", "", Format(server_datetime(), "yyyy-MM-dd"), "", Format(server_datetime(), "yyyy-MM-dd"), _
                                                        DataGridView1.Item(0, i).Value, DataGridView1.Item(1, i).Value, DataGridView1.Item(3, i).Value, _
                                                        DataGridView1.Item(5, i).Value, DataGridView1.Item(6, i).Value, DataGridView1.Item(7, i).Value, DataGridView1.Item(8, i).Value, _
                                                        txt_curr.Text, 1, i, "UPDATE", 0, var_po, Replace(txt_disc.Text, "%", ""), cbo_akun.Text, DataGridView1.Item(2, i).Value, Replace(txt_kurs.Text, ",", ""), Replace(txt_um.Text, ",", ""), cbo_gudang.EditValue)
    ...
    Private Sub generate()
        ...
        edit = 1
        insert = 0
        DT = select_pelunasan_po("", noPurchase, 1, var_date, tglawal.Value, tglakhir.Value)
        Rows = DT.Rows.Count - 1
        ...
        For i = 0 To Rows
            ...
            DataGridView1.Item(5, i).Value = FormatNumber(DT.Rows(i).Item("qtypo"), 0)
    ...
    Private Sub btn_del2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_del2.Click
        ...
        If edit = 1 Then
            If getTemplateAkses(username, "MN_PURCHASE_UM_LUNAS_DELETE") <> True Then
                Dim info As AlertInfo = New AlertInfo("Cek Kevaliditasan Data", "Anda tidak memiliki hak akses")
                alertControl_warning.Show(Me, info)
                Exit Sub
            End If
        ...
        If edit = 1 Then
            ...
            If pesan = vbYes Then
                Call delete_pelunasan_po(Trim(txt_inv_no.Text), Format(txt_date.Value, "yyyy-MM-dd"), Lookup_Pelanggan.EditValue, _
                                var_id_supplier, var_pay_method, txt_payterm.Text, txt_discterm.Text, Replace(txt_disc_pay.Text, "%", ""), _
                                txt_subtotal.Text, txt_freight.Text, Replace(txt_tax.Text, "%", ""), txt_amount.Text, Trim(txt_comment.Text), _
                                username, Format(server_datetime(), "yyyy-MM-dd"), username, Format(server_datetime(), "yyyy-MM-dd"), _
                                0, "", "", 0, "", 0, 0, Trim(txt_curr.Text), 0, 0, "DELETE", 0, var_po, Replace(txt_disc.Text, "%", ""), cbo_akun.Text, "", Replace(txt_kurs.Text, ",", ""), Replace(txt_um.Text, ",", ""), cbo_gudang.EditValue)
                If param_sukses = True Then
    ...
    Private Sub view_data()
        ...
        Try
            ...
            Else
                var_date = 0
            End If
            DT = select_pelunasan_po(Trim(cbo_search.Text), Trim(txt_search.Text), 0, var_date, tglawal.Value, tglakhir.Value)
    ...
    Private Sub view_data_po(ByVal Criteria As String)
        ...
        TSubTotal = 0
        If edit = 0 Then
            DT = select_po_pelunasan("No PO", Criteria, date_filter, Format(server_datetime(), "yyyy-MM-dd"), Format(server_datetime(), "yyyy-MM-dd"))
        Else
            DT = select_po_pelunasan_all("No PO", Criteria, date_filter, Format(server_datetime(), "yyyy-MM-dd"), Format(server_datetime(), "yyyy-MM-dd"))
        End If
        Rows = DT.Rows.Count - 1
        txt_freight.Text = FormatNumber(DT.Rows(0).Item("freight"), 0)
        txt_curr.Text = DT.Rows(0).Item("id_curr")
        ...
        If DT.Rows().Count > 0 Then
            For i = 0 To Rows
                ...
                DataGridView1.Item(5, i).Value = FormatNumber(DT.Rows(i).Item(3), 0)
    ...
    Private Sub fillComboBoxAll()
        Dim DT As DataTable
        DT = select_list_po_pelunasan_all()
