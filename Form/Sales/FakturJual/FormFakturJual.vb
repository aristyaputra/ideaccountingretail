...
Public Class FormFakturJual
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Dim qryCompanies As String = "SELECT * FROM view_ctk_sales where no_sales = '" & frmsales.NoFakturJual & "'"
            ...
            R.Refresh()
            R.RecordSelectionFormula = "{view_ctk_so1.no_sales} ='" & frmsales.NoFakturJual & "'"
            With CRviewer
                .ReportSource = R
