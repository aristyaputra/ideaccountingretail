...
Public Class frmDPso
    ...
    Private Sub frmDPso_Activated(sender As Object, e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub frmso_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        ...
        '    NewDisplayAcc.formsource_so_item = True
        '    NewDisplayAcc.Show()
    ...
    Private Sub cbo_customer_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_customer.Click
        ...
        NewDisplayAcc.formsource_so = True
        NewDisplayAcc.Show()
        ' MainMenu.Enabled = False
        Me.Enabled = False
    ...
    Private Sub insert_data()
        ...
        If insert = 1 Then
            Call insert_sales_order_um(Trim(txt_so_no.Text), cbo_customer.Text, txt_date.Value, txt_comment.Text, Replace(txt_subtotal.Text, ",", ""), _
                                Replace(txt_tax.Text, "%", ""), Replace(txt_total.Text, ",", ""), username, server_datetime(), server_datetime(), username, _
                                0, "", "", 0, "", 0, 0, "", 0, 0, Replace(txt_kurs.Text, ",", ""), Trim(cbo_marketing.Text), "", "", "", "", 0, 0, 0, Replace(txt_disc.Text, ",", ""), Replace(txt_netto.Text, ",", ""), var_is_discbrand, var_is_disctype, var_is_disccat, var_is_discitem, 0, DataGridView1.Item(8, i).Value, DataGridView1.Item(9, i).Value, DataGridView1.Item(10, i).Value, Replace(txt_um.Text, ",", ""), Trim(cbo_acc.Text), Trim(cbo_curr_um.Text), Replace(txt_kurs.Text, ",", ""), cbo_ekspedisi.Text, Replace(TextBox1.Text, ",", ""), Format(txt_tgl_um.Value, "yyyy-MM-dd"))
            For i = 0 To DataGridView1.Rows.Count - 1
                If Trim(DataGridView1.Item(1, i).Value) <> "" Then
                    Call insert_sales_order_um(Trim(txt_so_no.Text), cbo_customer.Text, txt_date.Value, txt_comment.Text, Replace(txt_subtotal.Text, ",", ""), _
                                Replace(txt_tax.Text, "%", ""), Replace(txt_total.Text, ",", ""), username, server_datetime(), server_datetime(), username, _
                                DataGridView1.Item(0, i).Value, DataGridView1.Item(1, i).Value, DataGridView1.Item(3, i).Value, DataGridView1.Item(4, i).Value, DataGridView1.Item(5, i).Value, DataGridView1.Item(6, i).Value, DataGridView1.Item(7, i).Value, txt_curr.Text, 1, 0, Replace(txt_kurs.Text, ",", ""), Trim(cbo_marketing.Text), DataGridView1.Item(2, i).Value, DataGridView6.Item(1, i).Value, DataGridView6.Item(2, i).Value, DataGridView6.Item(4, i).Value, Replace(DataGridView3.Item(3, i).Value, ",", ""), Replace(DataGridView4.Item(3, i).Value, ",", ""), Replace(DataGridView5.Item(3, i).Value, ",", ""), Replace(txt_disc.Text, ",", ""), Replace(txt_netto.Text, ",", ""), var_is_discbrand, var_is_disctype, var_is_disccat, var_is_discitem, Replace(DataGridView6.Item(3, i).Value, ",", ""), DataGridView1.Item(8, i).Value, DataGridView1.Item(9, i).Value, DataGridView1.Item(10, i).Value, Replace(txt_um.Text, ",", ""), Trim(cbo_acc.Text), Trim(cbo_curr_um.Text), Replace(txt_kurs.Text, ",", ""), cbo_ekspedisi.Text, Replace(TextBox1.Text, ",", ""), Format(txt_tgl_um.Value, "yyyy-MM-dd"))
                End If
            Next
        ...
        ElseIf edit = 1 Then
            If select_validate("Sales Order", Trim(txt_so_no.Text)) > 0 Then
                ...
                Exit Sub
            End If
            Call update_sales_order_um(Trim(txt_so_no.Text), cbo_customer.Text, txt_date.Value, txt_comment.Text, Replace(txt_subtotal.Text, ",", ""), _
                                Replace(txt_tax.Text, "%", ""), Replace(txt_total.Text, ",", ""), username, server_datetime(), server_datetime(), username, _
                                0, "", "", 0, "", 0, 0, "", 0, 0, Replace(txt_kurs.Text, ",", ""), Trim(cbo_marketing.Text), "", "", "", "", 0, 0, 0, Replace(txt_disc.Text, ",", ""), Replace(txt_netto.Text, ",", ""), var_is_discbrand, var_is_disctype, var_is_disccat, var_is_discitem, 0, DataGridView1.Item(8, i).Value, DataGridView1.Item(9, i).Value, DataGridView1.Item(10, i).Value, Replace(txt_um.Text, ",", ""), Trim(cbo_acc.Text), Trim(cbo_curr_um.Text), Replace(txt_kurs.Text, ",", ""), cbo_ekspedisi.Text, Replace(TextBox1.Text, ",", ""), Format(txt_tgl_um.Value, "yyyy-MM-dd"))
            For i = 0 To DataGridView1.Rows.Count - 1
                If Trim(DataGridView1.Item(1, i).Value) <> "" Then
        ...
        If edit = 1 Then
            ...
            If pesan = vbYes Then
                Call delete_sales_order(Trim(txt_so_no.Text), cbo_customer.Text, txt_date.Value, txt_comment.Text, Replace(txt_subtotal.Text, ",", ""), _
                                Replace(txt_tax.Text, "%", ""), Replace(txt_total.Text, ",", ""), username, server_datetime(), server_datetime(), username, _
                                0, "", "", 0, "", 0, 0, "", 0, 0, Replace(txt_um.Text, ",", ""), Trim(cbo_acc.Text), Trim(cbo_curr_um.Text), Replace(txt_kurs.Text, ",", ""))
                If param_sukses = True Then
    ...
    Private Sub DataGridView2_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView2.CellClick
        ...
        If colIndex = 7 Then
            Dim DisplayNota As New FormNotaUM
    ...
    Private Sub DataGridView2_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGridView2.DoubleClick
        ...
        If Replace(txt_um.Text, ",", "") <> 0 And Trim(txt_um.Text) <> "" Then
            btn_cetak.Enabled = True
        End If
        btn_show_um_Click(sender, e)
    End Sub
    ...
    Private Sub cbo_marketing_GotFocus(sender As Object, e As System.EventArgs)
        open_conn()
    ...
    Private Sub chk_brand_CheckedChanged(sender As System.Object, e As System.EventArgs)
        Dim rows As Integer
    ...
    Private Sub chk_type_CheckedChanged(sender As System.Object, e As System.EventArgs)
        Dim rows As Integer
    ...
    Private Sub chk_category_CheckedChanged(sender As System.Object, e As System.EventArgs)
        Dim rows, rows_disc_brand, rows_disc_type, rows_disc_cat As Integer
    ...
    Private Sub btn_show_um_Click(sender As System.Object, e As System.EventArgs) Handles btn_show_um.Click
        Panel2.Visible = True
    ...
    Private Sub cbo_curr_um_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles cbo_curr_um.SelectedIndexChanged
        txt_kurs_um.Text = FormatNumber(get_kurs(cbo_curr_um.Text), 0)
    End Sub

    Private Sub TabInput_Click(sender As System.Object, e As System.EventArgs)
